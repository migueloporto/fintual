class Portfolio{
    ...
    getPriceStocks(stock, date){
        ...
        .then(r=>{
            let price = 0;
            if(r.historical && r.historical[0])
                price = r.historical[0].close;
...
let portfolio = new Portfolio(),
    ...
    .then((resp)=>{
        ...
        document.getElementById('result').innerHTML = 'El rendimiento de la cartea es: '+resp.profit+', y su rendimiento anualizado es de: '+resp.annualized;
    });